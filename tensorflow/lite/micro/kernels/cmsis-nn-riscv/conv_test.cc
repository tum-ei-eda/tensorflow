...
TF_LITE_MICRO_TEST(Kernel1x1QuantizedPerChannelRelu6) {
  ...
  const int kOutputElements = 4 * 3;
  int8_t output_data[kOutputElements];
  const float kGoldenData[] = {6, 2, 0, 6, 2, 0,
                                                    6, 4, 1, 6, 4, 1};
